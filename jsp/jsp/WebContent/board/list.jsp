...
// java와 jsp에서 공통으로 사용하는 데이터영역에 해당되는 객체 - request를 주로 사용한다.
...
$(function(){ //onready - html - body 부분의 내용이 다로딩되면 동작되도록한다.
...
<tr>
<td colspan="5"><a href="writeForm.jsp" class="btn btn-default">작성하기</a><br/>
</td>
</tr>
</table>
</div>
